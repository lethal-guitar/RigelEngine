...
enum class ActorID {
  Hoverbot = 0,
  Explosion_FX_auto_sound = 1,
  Explosion_FX_2 = 2,
  Shot_impact_FX_tile_burning = 3,
  Duke_LEFT = 5,
  Duke_RIGHT = 6,
  Dukes_rocket_up = 7,
  Dukes_rocket_down = 8,
  Dukes_rocket_left = 9,
  Dukes_rocket_right = 10,
  Smoke_puff_FX = 11,
  ...
  Fast_green_cat_LEFT = 31,
  Fast_green_cat_RIGHT = 32,
  Muzzle_flash_up = 33,
  ...
  Dukes_ship_RIGHT = 87,
  Dukes_ship_UNCLEAR1 = 89,
  Dukes_ship_UNCLEAR2 = 90,
  ...
  Auto_open_vertical_door = 128,
  Keyhole_mounting_pole = 129,
  Blowing_fan = 130,
  Laser_turret = 131,
  Auto_open_horizontal_door = 132,
  Restart_beacon = 133,
  Skeleton = 134,
  ...
  Petrified_monster_LEFT = 189,
  Petrified_monster_RIGHT = 190,
  Petrified_monster_eye_FX_2 = 191,
  Petrified_monster_stone_debris_1 = 192,
  Petrified_monster_stone_debris_2 = 193,
  Petrified_monster_stone_debris_3 = 194,
  Petrified_monster_stone_debris_4 = 195,
  Petrified_monster_stone_debris_5 = 196,
  Petrified_monster_stone_debris_6 = 197,
  Petrified_monster_stone_debris_7 = 198,
  Petrified_monster_stone_debris_8 = 199,
  BOSS_Episode_1 = 200,
  Red_box_turkey = 201,
  Turkey = 202,
  Red_bird = 203,
  ...
  Lava_pit = 212,
  Messenger_drone_YOUR_BRAIN_IS_OURS = 213,
  Messenger_drone_BRING_BACK_THE_BRAIN = 214,
  Messenger_drone_LIVE_FROM_RIGEL_ITS_SATURDAY_NIGHT = 215,
  Messenger_drone_DIE = 216,
  Blue_guard_using_a_terminal = 217,
  Super_force_field_RIGHT = 218,
  Smash_hammer = 219,
  Messenger_drone_YOU_CANNOT_ESCAPE_US_YOU_WILL_GET_YOUR_BRAIN_SUCKED = 220,
  Water_depths = 221,
  Lava_fall_1 = 222,
  Lava_fall_2 = 223,
  Water_fall_1 = 224,
  ...
  Flame_jet_3 = 248,
  Flame_jet_4 = 249,
  Airlock_effect_LEFT = 250,
  Airlock_effect_RIGHT = 251,
