...
enum class ActorID {
    ...
    Living_statue_LEFT = 189,
    Living_statue_RIGHT = 190,
    Living_statue_eye_FX_RIGHT = 191,
    Living_statue_stone_debris_1_LEFT = 192,
    Living_statue_stone_debris_2_LEFT = 193,
    Living_statue_stone_debris_3_LEFT = 194,
    Living_statue_stone_debris_4_LEFT = 195,
    Living_statue_stone_debris_1_RIGHT = 196,
    Living_statue_stone_debris_2_RIGHT = 197,
    Living_statue_stone_debris_3_RIGHT = 198,
    Living_statue_stone_debris_4_RIGHT = 199,
    BOSS_Episode_1 = 200,
    Red_box_turkey = 201,
    Turkey = 202,
    Red_bird = 203,
