...
# Locate SDL2 library
#
# This file is a modified version of the file FindSDL.cmake bundled with CMake.
#
# This module defines
#
# ::
...
#   SDLMAIN2_LIBRARY, the name of the SDLmain library to link against
...
# Similarly, if you see an empty SDLMAIN2_LIBRARY, you should set this
...
pkg_check_modules(PKG_CONF_SDL2 QUIET sdl2)

find_path(SDL2_INCLUDE_DIR SDL.h
  HINTS
    ENV SDL2DIR
    ${PKG_CONF_SDL2_INCLUDEDIR}
    ${PKG_CONF_SDL2_INCLUDE_DIRS}
  PATH_SUFFIXES SDL2
...
find_library(SDL2_LIBRARY_TEMP
  ...
  HINTS
    ENV SDL2DIR
    ${PKG_CONF_SDL2_LIBDIR}
    ${PKG_CONF_SDL2_LIBRARY_DIRS}
...
if(SDL2_LIBRARY_TEMP)
  # For SDLmain
  if(SDLMAIN2_LIBRARY AND NOT SDL2_BUILDING_LIBRARY)
    list(FIND SDL2_LIBRARY_TEMP "${SDLMAIN2_LIBRARY}" _SDL_MAIN_INDEX)
    if(_SDL_MAIN_INDEX EQUAL -1)
      set(SDL2_LIBRARY_TEMP "${SDLMAIN2_LIBRARY}" ${SDL2_LIBRARY_TEMP})
    endif()
